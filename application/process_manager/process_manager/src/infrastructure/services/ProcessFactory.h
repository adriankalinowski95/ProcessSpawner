...
public:
    ...
    ProcessFactory(std::shared_ptr<IPlatformProcessLauncher> launcher, std::shared_ptr<IPlatformIO> io, std::shared_ptr<ILogger> logger) :
        m_launcher{ launcher }, 
        m_io{ io },
        m_logger{ logger } {}
...
private:
    std::shared_ptr<IPlatformProcessLauncher> m_launcher;
    std::shared_ptr<IPlatformIO> m_io;
